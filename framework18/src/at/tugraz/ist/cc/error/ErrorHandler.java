...
public enum ErrorHandler {
    ...
    /**
     * Prints a summary of previously added lexer and parser errors in a
     * formated way to stdout.
     * <p>
     * Wrapper-method which uses {@link #checkAndPrintErrors(int)} to print a
     * summary of all errors specified for task 1.
     * <p>
     * Does not print parser errors if lexer errors are present.
     */
    public void printTask1Errors() {
        if (checkAndPrintErrors(LEX_ERR))
            checkAndPrintErrors(PARSE_ERR);
    }
     ...
     * <p>
     * Wrapper-method which uses {@link #checkAndPrintErrors(int)} to print a
     * summary of all errors and warning as specified for task 2.
     * <p>
     * Stops printing the summary if errors are present.
     * 
     * 
     */
    public void printTask2ErrorsAndWarnings() {
    ...
    /**
     * Creates a new
     * {@link at.tugraz.ist.cc.warning.typechecker.ReturnCoecrionWarning}
     * instance and adds it to the list of type warnings. Use this method to add
    ...
    public void addMainInstatiationError(int line, int char_pos) {
        errors.get(TYPE_ERR).add(fact.createInstatiationError(line, char_pos));
    }
